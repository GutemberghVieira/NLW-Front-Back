...
export function Habit(){
    ...
    const dayAndMonth = parsedDate.format('DD/MM')
     ...
     const  habitsProgress = dayInfo?.possíbleHabits.length ? generateProgressPercentage(dayInfo.possíbleHabits.length, completedHabits.length) :0;
        ...
        <View className="flex-1 bg-background px-7 pt-16">
            ...
            {dayAndMonth}
             ...
             <View className={clsx("mt-6", {
               ...
               dayInfo?.possíbleHabits ? dayInfo?.possíbleHabits.map(habit => (
                <Checkbox 
                key={habit.id}
                title={habit.title}
